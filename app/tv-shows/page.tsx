        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <h1 className="text-3xl font-bold font-playfair tracking-tight text-glow">TV Shows</h1>
            ...
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="all" className="pt-6 space-y-10">
                <ContentSlider title="Trending Now" contents={trendingNow.filter((c) => c.type === "series")} />
                <ContentSlider title="New Releases" contents={newReleases.filter((c) => c.type === "series")} />
                <ContentSlider title="Top Rated" contents={topRated.filter((c) => c.type === "series")} />
              </TabsContent>
